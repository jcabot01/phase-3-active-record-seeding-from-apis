...
spells.each do |spell|
  ...
  response = RestClient.get "https://www.dnd5eapi.co/api/spells/#{spell}" #interpolate each spell

  #the response will come back as a JSON-formmated string.
  #use the JSON.parse method to convert the string into a Ruby hash:
